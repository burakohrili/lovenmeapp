...
class _SplashPageState extends State<SplashPage> 
  ...
  void _navigateToIncompleteProfileStep(Map<String, dynamic> userData) {
    // Devam mantigi artik OnboardingRouter'da (lib/core/utils). Ayni mantik
    // burada ve giris ekraninda iki kez durmasin; giris ekrani zaten
    // koşulsuz Adim 1'e atiyordu.
    if (!mounted) return;
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => OnboardingRouter.resumePage(userData),
      ),
    );
  }
